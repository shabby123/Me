...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Initialize CoreDataStore and set managed object context
    [[CoreDataStore sharedClient] setManagedObjectContext:self.managedObjectContext];
    
    // Create root object
    [[CoreDataStore sharedClient] createRootItem];
    
    // Setup appearance
    [UIHelper setupAppearance];
